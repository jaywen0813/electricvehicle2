...
public class ZXDOutAdapter_SoItem extends BaseAdapter {
    ...
    public ZXDOutAdapter_SoItem(Context context, List<ItemDetailOutVO.DataBean.PackingListItemsBean> list) {
