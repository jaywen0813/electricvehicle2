...
public class MainAdapter2 extends BaseAdapter {
    ...
    public MainAdapter2(Context context, List<ActivityVO.ResultBeanX.ResultBean> activityVOList) {
...
//            holder.tvDate = view.findViewById(R.id.tvDate);
        ...
        ActivityVO.ResultBeanX.ResultBean bean = activityVOList.get(position);
