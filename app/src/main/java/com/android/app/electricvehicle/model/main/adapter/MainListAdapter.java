...
public class MainListAdapter extends BaseQuickAdapter<ActivityVO.ResultBeanX.ResultBean, BaseViewHolder> {

    private List<ActivityVO.ResultBeanX.ResultBean> data;
    private Activity activity;

    public MainListAdapter(@Nullable List<ActivityVO.ResultBeanX.ResultBean> data, Activity activity) {
