package com.android.app.electricvehicle.utils.toast;
...
/**
 * StyleableToast is a very easy and quick way to style your styleableToast and gives them an unique style and
 * feeling compared
...
public class StyleableToast extends Toast implements OnToastFinished {
    ...
    public void show() {
        // FIXME: 2017/12/20  增加 判断如果toast不为空就不new
    ...
    private GradientDrawable getShape() {
        ...
        gradientDrawable.setCornerRadius(Utils.getTypedValueInDP(context, cornerRadius));
        gradientDrawable.setStroke((int) Utils.getTypedValueInDP(context, strokeWidth), strokeColor);
    ...
    private TextView getTextView() {
        ...
        if (icon > 0) {
            ...
            int leftPadding = (int) Utils.getTypedValueInDP(context, 41);
            int rightPadding = (int) Utils.getTypedValueInDP(context, 25);
    ...
    private ImageView getIcon() {
        if (icon > 0) {
            ...
            int marginRight = (int) Utils.getTypedValueInDP(context, 15);
    ...
    private Animation getAnimation() {
        if (hasAnimation) {
            RotateAnimation anim = new RotateAnimation(0.0f, 360.0f, Animation.RELATIVE_TO_SELF, 0.5f, Animation
    ...
    /**
     * A callback that automatically cancels and resets animation effect from spinIcon(); when the StyleableToast is
     * finished showing on screen.
