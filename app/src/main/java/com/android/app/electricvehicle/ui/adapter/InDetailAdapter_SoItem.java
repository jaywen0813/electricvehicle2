...
public class InDetailAdapter_SoItem extends BaseAdapter {
    ...
    public InDetailAdapter_SoItem(Context context, List<ItemDetailOutVO.DataBean.PackingBean.PackingItemsBean> list) {
